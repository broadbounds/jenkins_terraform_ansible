    ...
    stage('TerraformApply'){
        ...
        steps {
            script{                    
                ...
                sh "ansible-playbook -i /var/lib/jenkins/.ssh/inventory.ini playbook.yml  --user ec2-user --key-file /var/lib/jenkins/.ssh/ssh_private_key.pem -e 'key=/var/lib/jenkins/.ssh/ssh_public_key.pem'"
